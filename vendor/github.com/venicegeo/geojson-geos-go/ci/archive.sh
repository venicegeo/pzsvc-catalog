...
go get -v github.com/venicegeo/geojson-geos-go/...

# run unit tests w/ coverage collection
go test -v -coverprofile=$root/geojson-geos-go.cov github.com/venicegeo/geojson-geos-go/geojsongeos

# lint
cd $GOPATH/src/github.com/venicegeo/geojson-geos-go
